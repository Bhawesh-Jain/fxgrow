    ...
    return (
        <div className="bg-black text-white">
            <div>
                ...
                <div className="flex flex-row content-center"><MdLocationPin size={30}/> <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dolore autem numquam consectetur ad.</p></div>
